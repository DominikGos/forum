...
Route::group([
    ...
    Route::get('/user/{id}/edit', 'UserController@edit')->name('user.edit'); //zmień profle na user

    Route::put('/user/{id}/update', 'UserController@update')->name('user.update'); //zmień profle na user
